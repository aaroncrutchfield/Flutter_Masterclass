import 'package:{{project_name.snakeCase()}}/app/di/data/get_it/get_it_registry_source.dart';
import 'package:{{project_name.snakeCase()}}/app/di/data/injectable/injectable_config.dart';
